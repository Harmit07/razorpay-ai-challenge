...
| **[`EDGE-04`](edge-cases.md#4-edge-04-mandate-expiring-mid-retry-cycle)** | [Mandate Expiring in 24h](edge-cases.md#4-edge-04-mandate-expiring-mid-retry-cycle) | Mandate expires before cooling + retry window ([RBI E-Mandate](#rule-1-rbi-2026-e-mandate)). | **BLOCKED:** Refuses auto-debit; dispatches instrument renewal link. |
| **[`EDGE-05`](edge-cases.md#5-edge-05-trai-quiet-hours-sleep-trap-failure-at-2345-ist)** | [TRAI Quiet Hours Violation](edge-cases.md#5-edge-05-trai-quiet-hours-sleep-trap-failure-at-2345-ist) | Outbound customer touch at 11:30 PM IST ([TRAI TCCCPR 2018](#rule-4-trai-quiet-hours)). | **BLOCKED:** Instant send blocked; queued for release at 08:30 AM IST next morning. |
| **[`EDGE-06`](edge-cases.md#6-edge-06-active-promise-to-pay-ptp-race-condition)** | [Promise-to-Pay (PTP) Grace Window](edge-cases.md#6-edge-06-active-promise-to-pay-ptp-race-condition) | Customer committed to pay on Sept 5th ([PTP Policy](#rule-6-ptp-grace-window)). | **FROZEN:** Dunning touches quarantined in `PTP_FROZEN` state until Sept 6th. |
| **[`EDGE-07`](edge-cases.md#7-edge-07-post-failure-mandate-revocation-by-user)** | [Revoked Mandate Debit](edge-cases.md#7-edge-07-post-failure-mandate-revocation-by-user) | Customer cancelled mandate via bank portal ([RBI Mandate Rules](#rule-3-revoked-mandates-halted)). | **BLOCKED:** Permanent freeze (`STOP_MANDATE_REVOKED`); zero touches dispatched. |
| **[`EDGE-08`](edge-cases.md#8-edge-08-fraud-chargeback--active-dispute-straddle)** | [Active Fraud Dispute / Chargeback](edge-cases.md#8-edge-08-fraud-chargeback--active-dispute-straddle) | Customer filed fraud dispute with issuing bank ([CPA 2019](#rule-5-cpa-2019-dispute-lock)). | **BLOCKED:** Quarantined under CPA 2019 (`STOP_DISPUTE_FRAUD`); retries stopped. |
| **[`EDGE-09`](edge-cases.md#9-edge-09-msmed-45-day-statutory-ceiling-clash-b2b-invoice-on-day-43)** | [B2B MSMED 45-Day Boundary](edge-cases.md#9-edge-09-msmed-45-day-statutory-ceiling-clash-b2b-invoice-on-day-43) | Commercial invoice overdue approaching 45 days ([MSMED Act 2006](#rule-8-msmed-act-2006)). | **ESCALATED:** Standard dunning halted; escalated directly to finance operations. |
| **[`EDGE-10`](edge-cases.md#10-edge-10-unmapped-decline-with-high-risk-flag)** | [Raw Ambiguous Decline String](edge-cases.md#10-edge-10-unmapped-decline-with-high-risk-flag) | Bank returns unmapped unstructured string ([13-Bucket Taxonomy](root-cause-taxonomy.md)). | **DISAMBIGUATED:** Resolved via semantic engine without blocking merchant flow. |
